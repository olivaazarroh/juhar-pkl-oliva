                ...
                <div class="col-6">
                    <div class="bg-light rounded p-4 p-sm-5 my-4 mx-3">
                       <div class="text-center">
                        ...
                        <h4>JUHAR PKL</h4>
                        <p>Sistem jurnal harian PKL berbasis websate, silahkan masuk untuk informasi lebih lanjut</p>
                       </div>
                       <a href="">
                        <div class="card shadow-sm">
                            <div class="card-body">
                               <div class="d-flex align-items-center">
                                    <img src="{{ asset('img/guru.png')}}" alt="LOGO" height="100">
                                    <div class="ms-2">
                       ...
                       <a href="">
                        <div class="card shadow-sm">
                            <div class="card-body">
                               <div class="d-flex align-items-center">
                                    <img class="ms-1" src="{{ asset('img/siswa.png')}}" alt="LOGO" height="100">
                                    <div class="ms-5">
